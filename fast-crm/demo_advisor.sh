...
UPLOAD_RESPONSE=$(curl -s -X POST -H "Content-Type: application/json" \
  ...
  "https://svc-01k64d7wz072n0rf3zz7pw39y0.01k2trmrbsdx3erbaamwzzydy8.lmapp.run/api/v1/upload_advisor_document")
...
DOCS_RESPONSE=$(curl -s "https://svc-01k64d7wz072n0rf3zz7pw39y0.01k2trmrbsdx3erbaamwzzydy8.lmapp.run/api/v1/advisor_documents")
...
EMAIL_RESPONSE=$(curl -s -X POST -H "Content-Type: application/json" \
  ...
  "https://svc-01k64d7wz072n0rf3zz7pw39y0.01k2trmrbsdx3erbaamwzzydy8.lmapp.run/api/v1/process_email")
