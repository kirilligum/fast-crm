/**
 * Setup script to store the TriageBot system prompt in SmartMemory
 * This should be run once during deployment to initialize the prompt
 */

// Triage System Prompt for LiquidMetal AI CRM
...
console.log('TriageBot System Prompt for SmartMemory:');
console.log('='.repeat(50));
console.log(TRIAGE_SYSTEM_PROMPT);
console.log('='.repeat(50));
console.log('\nTo store this prompt in SmartMemory, use:');
console.log('env.AGENT_MEMORY.put("triage-prompt", { content: PROMPT_CONTENT })');
